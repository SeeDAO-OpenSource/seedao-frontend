...
import SGNCard from "../components/daofans/SGNCard.vue";
...
export default {
    ...
    methods: {
        ...
        handleKeywordsChange: debounce(function() {
            this.handleSearch();
        }, 300),
    },
};
...
<template>
    <div class="grid grid-flow-row auto-rows-max">
        <!-- banner -->
        <div
            class="daofans-header flex flex-row items-center justify-center relative"
        >
            <img
        ...
        >
            <div class="titlefont">累计MINT：{{ sgnObjs.length }}</div>
        ...
        >
            <SGNCard v-for="sgn in sgnObjs" :key="sgn.address" :sgnObj="sgn" />
        </div>
    </div>
</template>
